...
def recivedMsg():
    ...
    while True:
        ...
        if randomNumber in currentNumberList and flashNumberLabel and not gameOver:
            flashNumberList.append(int(message))
            canvas2.itemconfigure(flashNumberLabel, text=message, font=('Chalkboard SE', 60))
